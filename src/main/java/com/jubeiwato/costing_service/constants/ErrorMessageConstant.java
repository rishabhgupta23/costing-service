...
public class ErrorMessageConstant {
    ...
    public static final String CATEGORY_ALREADY_EXISTS_TEMPLATE = "Category with categoryName '%s' already exists";    public static final String COST_FACTOR_ALREADY_EXISTS_TEMPLATE = "Costfactor with costfactor name '%s' already exists";
