...
public class PartResponseDto extends PartDto {
    ...
    public PartResponseDto(Long partId, String partName, String partNumber, String categoryName, String type, String unit, List<VendorCostDto> vendorCostList, List<BomResponseDto> bom) {
